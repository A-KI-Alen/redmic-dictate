...
class ConfigTests(unittest.TestCase):
    def test_default_config_matches_hotkey_plan(self) -> None:
        ...
        self.assertEqual(config.quality_threads, "2")
        self.assertEqual(config.quality_chunk_seconds, 10)
        self.assertEqual(config.quality_max_fast_backlog, 0)
        self.assertEqual(config.quality_wait_after_stop_seconds, 6.0)
